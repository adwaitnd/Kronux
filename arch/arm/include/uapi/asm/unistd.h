...
#endif
#if     defined(__TIMELINE__) || defined(CONFIG_TIMELINE)  //Added by Sandeep D'souza 
#define __NR_timeline_wait_until                    (__NR_RK_SYSCALL_BASE+29) 
#define __NR_timeline_sleep                              (__NR_RK_SYSCALL_BASE+30) 
#endif
