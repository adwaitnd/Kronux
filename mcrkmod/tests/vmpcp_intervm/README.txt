...
10. (optional) Check if vchannel messages are correctly delivered
 - Guest:
        $ cat /proc/interrupts
	...
	52:         19          0          0          0   PCI-MSI-edge      virtio6-virtqueues
...
11. Host: set event log for guest VCPUs 
	$ cd mcrkmod/utils/
...
12. Host: register vchannel for guest VM (needs sudo) 
...
13. Guest: register vchannel for itself (needs sudo)
	$ cd mcrkmod/utils/virt
...
18. Host/Guest: unload RK module
 - "sudo rmmod rk" in the guest may be stalled until the host RK module is unloaded.
